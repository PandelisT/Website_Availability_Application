...
class TestWebsiteAvailabilityFunctions(unittest.TestCase):
    ...
    def test_get_ip_address(self):
        website = WebsiteAvailability(os.environ.get("TEST_DOMAIN")) # os.environ.get("TEST_DOMAIN")
        ip_address = website.get_ip_address()
        self.assertIsInstance(ip_address, str)
        self.assertEqual(ip_address, os.environ.get("TEST_IP_ADDRESS") ) # os.environ.get("TEST_IP_ADDRESS")
